<div class="block">
    ...
    echo form_open_multipart('Budidaya_tan/edit_budidaya') ?>

    <div class=" form-group">
        <label class="col-md-3 control-label" for="example-hf-email">Nama Hama & Penyakit</label>
        <div class="col-md-9">
            <input type="text" id="example-hf-email" name="nama" class="form-control" value="" placeholder="Masukkan Nama Hama & Penyakit..">
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-3 control-label" for="example-hf-password">Nama Latin</label>
        <div class="col-md-9">
            <input type="text" id="example-hf-password" name="nama_latin" value="" class="form-control" placeholder="..">
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-3 control-label" for="example-hf-password">Nama Daerah</label>
        <div class="col-md-9">
            <input type="text" id="example-hf-password" name="nama_daerah" value="" class="form-control" placeholder="..">
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <div class="col-md-16">
            <textarea id="example-textarea-input" name="deskripsi" cols="100" rows="10" value="" class="form-control" placeholder="Content.."> </textarea>
        </div>
    </div>
