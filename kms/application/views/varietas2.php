        ...
        if ($picture!='' AND $picture!='no_image.jpg'){ ?>
			<div class="col-md-6 col-xl-2">
                    <a class="block block-transparent" href="<?php echo base_url();?>frontend/varietas/detail_varietas/<?php echo $idvar?>">
                        <div class="block-content block-content-full bg-image block-rounded" style="background-image: url('<?php echo base_url();?>assets/gambar/varietas/<?php echo $picture;?>');">
...
Highcharts.chart('container', {
    ...
    title	: { text: 'Varietas <?php echo $komoditas;?> Paling Sering Dipesan' },
    xAxis	: { type: 'category' },
    yAxis	: { title: { text: 'Total Pesanan' } },
        ...
        "data": [<?php
			...
			foreach ($top->result_array() as $row){
				...
				foreach ($varietas->result_array() as $row2){ ?>
					{ "name": "<?php echo $row2['nmvarietas'];?>", "y": <?php echo $row['jml'];?>}, 
				<?php
				}
			} ?>
        ]
